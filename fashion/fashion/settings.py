...
SECRET_KEY = 'django-insecure-q#80rcuk26&8tlooh6(&1cll69d6ts@q1%&a+eoblqqoep!*zg'
...
if DEBUG:
    MEDIA_URL = '/media/'
    STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "fashion", "static", "static-only")
    MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR), "fashion", "static", "media")
    STATICFILES_DIRS = (os.path.join(os.path.dirname(BASE_DIR), "fashion", "static", "static"),)
